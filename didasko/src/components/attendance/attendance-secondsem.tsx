  ...
  const fetchSchedules = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('Filtered second semester schedules:', secondSemesterSchedules);
    ...
    return (
      <Card className='p-4 shadow-md rounded-lg'>
        <div className='text-center py-8'>
          ...
          <h2 className='text-xl font-semibold mb-2'>No Second Semester Courses</h2>
          <p className='text-gray-500'>You don't have any courses assigned for the second semester.</p>
        </div>
      </Card>
    );
  }
