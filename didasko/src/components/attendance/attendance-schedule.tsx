...
export default function Courses() {
  const courses = [
    ...
    { title: 'IT CAPSTONE', code: 'BSIT 611', time: '7:00 AM - 9:00 AM', day: 'M' },
    { title: 'MOBSTECH', code: 'BSIT 611', time: '7:00 AM - 9:00 AM', day: 'M' },
    { title: 'WEBSTECH', code: 'BSIT 611', time: '7:00 AM - 9:00 AM', day: 'M' },
    { title: 'DATABASE', code: 'BSIT 611', time: '9:00 AM - 11:00 AM', day: 'T' },
