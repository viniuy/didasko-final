...
const CourseCard = ({ title, code, year, absents, date }) => {
  return (
    <Card className='bg-[#124A69] text-white rounded-lg shadow-md p-4 w-[400px] flex flex-col justify-between h-full'>
      <div>
      ...
      <Button asChild variant="secondary" className="bg-[#FAEDCB] text-black text-sm">
    <a href="/grading/gradebook">View Grades</a>
</Button>
      </div>
    </Card>
  );
